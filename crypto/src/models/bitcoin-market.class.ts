export class BitcoinMarket {
  ...
  constructor(data?: any) {
    ...
    this.total_volume_usd = defaults.data.quotes.total_volume_usd;
    this.active_markets = defaults.data.active_markets;
    this.total_market_cap_by_available_supply_usd = defaults.data.quotes.total_market_cap_by_available_supply_usd
  }
}